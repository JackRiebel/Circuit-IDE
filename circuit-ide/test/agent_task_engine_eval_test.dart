...
void main() {
  group('AI task engine scenario evals', () {
    const scenarios = [
      ...
      _PromptScenario(
        prompt: 'can we build a tool to size customer datacenter refreshes',
        mode: StudioPromptMode.code,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
        mayCreateWorkspace: false,
      ...
      _PromptScenario(
        prompt: 'let\'s build a dashboard for branch migration planning',
        mode: StudioPromptMode.fix,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
        mayCreateWorkspace: false,
      ...
      _PromptScenario(
        prompt: 'we should build a portal for customer onboarding',
        mode: StudioPromptMode.code,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
        mayCreateWorkspace: false,
      ...
      _PromptScenario(
        prompt: 'I\'d like an app for sales engineers to compare options',
        mode: StudioPromptMode.code,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
        mayCreateWorkspace: false,
      ...
      _PromptScenario(
        prompt: 'we\'re thinking about building a tool for quote approvals',
        mode: StudioPromptMode.code,
      ...
      _PromptScenario(
        prompt: 'I need something for customer lifecycle tracking',
        mode: StudioPromptMode.code,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
        mayCreateWorkspace: false,
      ...
      _PromptScenario(
        prompt: 'we could use a dashboard for support escalation reviews',
        mode: StudioPromptMode.fix,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
        mayCreateWorkspace: false,
      ...
      _PromptScenario(
        prompt: 'we should have a portal for reseller onboarding',
        mode: StudioPromptMode.code,
        planModeEnabled: true,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
      ...
      _PromptScenario(
        prompt: 'I need help building an app for partner deal reviews',
        mode: StudioPromptMode.code,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
        mayCreateWorkspace: false,
      ...
      _PromptScenario(
        prompt: 'we need help creating a workflow for renewal approvals',
        mode: StudioPromptMode.code,
        planModeEnabled: true,
        expectedIntent: TurnIntent.ask,
        expectedToolMode: AgentToolMode.ask,
