...
void main() {
  ...
  test('end-to-end Studio reliability suite covers core user-pain flows', () {
    const suite = <_ReliabilitySource>[
      ...
      _ReliabilitySource(
        path: 'test/studio_keyboard_journey_test.dart',
        markers: [
          ...
          'Streaming the next response chunk.',
